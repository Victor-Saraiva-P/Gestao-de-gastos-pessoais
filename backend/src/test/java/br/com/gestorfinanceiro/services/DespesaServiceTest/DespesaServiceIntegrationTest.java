...
class DespesaServiceIntegrationTest {
    ...
    class CriarDespesaTest {
        ...
        void deveCriarDespesa() {
            ...
            DespesaEntity despesaSalva = despesaService.criarDespesa(despesaDTO, userId);

            assertNotNull(despesaSalva);
            assertEquals(despesaDTO.getValor(), despesaSalva.getValor());
            assertEquals(despesaDTO.getCategoria(), despesaSalva.getCategoria()
                    .getNome());
        }
        ...
        void erroAoCriarDespesaComValorInvalido() {
            ...
            assertThrows(InvalidDataException.class,
                    () -> despesaService.criarDespesa(despesaDTO, userId));
        }
        ...
        void erroAoCriarDespesaUsuarioNaoEncontrado() {
            DespesaCreateDTO despesaDTO = criarDespesaCreateDTO();
            String usuarioInexistente = UUID.randomUUID()
                    .toString();
    ...
    class ListarDespesasTest {
        ...
        void deveListarDespesasUsuario() {
            despesaService.criarDespesa(criarDespesaCreateDTO(), userId);
        ...
        void erroAoListarDespesasVazia() {
            ...
            String usuarioInexistente = "qualquer-id";
            assertThrows(DespesaNotFoundException.class,
                    () -> despesaService.listarDespesasUsuario(usuarioInexistente));
        }
    }
    ...
    class AtualizarDespesaTest {
        ...
        void erroAoAtualizarDespesaInexistente() {
            ...
            String uuidInexistente = UUID.randomUUID()
                    .toString();
    ...
    class ExcluirDespesaTest {
        ...
        void deveExcluirDespesa() {
            ...
            assertFalse(despesaRepository.findById(despesa.getUuid())
                    .isPresent());
        }
    ...
    class GerarGraficosTest {
        ...
        void deveGerarGraficoBarras() {
            ...
            GraficoBarraDTO grafico = despesaService.gerarGraficoBarras(userId, inicio, fim);

            assertNotNull(grafico);
            assertEquals(2, grafico.dadosMensais()
                    .size());
            assertEquals(
                    BigDecimal.valueOf(100)
                            .stripTrailingZeros(),
                    grafico.dadosMensais()
                            .get("janeiro 2024")
                            .stripTrailingZeros()
            );
            assertEquals(
        ...
        void deveGerarGraficoPizza() {
            ...
            GraficoPizzaDTO grafico = despesaService.gerarGraficoPizza(userId, inicio, fim);

            assertNotNull(grafico);
            assertEquals(3, grafico.categorias()
                    .size());
            assertEquals(
    ...
    class BuscaAvancadaTest {
        ...
        void deveBuscarDespesasPorIntervaloDeDatas() {
            ...
            List<DespesaEntity> despesas = despesaService.buscarDespesasPorIntervaloDeDatas(
                    userId, DATA_INICIO_2024, DATA_FIM_2024);
        ...
        void erroAoBuscarDespesasPorIntervaloDeDatasComDatasNulas() {
            ...
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeDatas(userId, null, DATA_FIM_2024));
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeDatas(userId, DATA_INICIO_2024, null));
        }
        ...
        void erroAoBuscarDespesasPorIntervaloDeDatasComInicioDepoisDoFim() {
            ...
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeDatas(
                            userId, DATA_10_JAN_2024, DATA_5_JAN_2024));
        }
        ...
        void deveBuscarDespesasPorIntervaloDeValores() {
            ...
            List<DespesaEntity> despesas = despesaService.buscarDespesasPorIntervaloDeValores(
                    userId, BigDecimal.valueOf(100), BigDecimal.valueOf(150));
        ...
        void erroAoBuscarDespesasPorIntervaloDeValoresComValoresNulos() {
            ...
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeValores(userId, null, VALOR_ATUALIZADO));
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeValores(userId, VALOR_PADRAO, null));
        }
        ...
        void erroAoBuscarDespesasPorIntervaloDeValoresComValoresMenoresOuIguaisAZero() {
            ...
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeValores(userId, BigDecimal.ZERO,
                            VALOR_ATUALIZADO));
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeValores(userId, VALOR_PADRAO,
                            BigDecimal.ZERO));
        }
        ...
        void erroAoBuscarDespesasPorIntervaloDeValoresComMinMaiorQueMax() {
            assertThrows(InvalidDataException.class,
                    () -> despesaService.buscarDespesasPorIntervaloDeValores(userId, VALOR_ATUALIZADO,
                            VALOR_PADRAO));
        }
    }
}